class Solution {
    public String longestCommonPrefix(String[] strs) {
        ...
        //sort approach
        //in my mind
        //if is sort the array strs -> [bag, band , bank , bat]
        //compare bag <---> bat
        //if - b == b , ba == ba  -> add to the output
        // bag != bat. -> break
        
        Arrays.sort(strs);
        String first = strs[0];//bag
        String last = strs[strs.length -1];//bat
        int i = 0;
        String output = first; //b a g 
